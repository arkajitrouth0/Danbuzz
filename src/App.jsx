    ...
    <div className="slide">
                ...
                return (
                  <div key={p.id} style={{display:"flex",alignItems:"center",gap:10,padding:"8px 12px",borderRadius:8,background:isMe?col.bg:"transparent",border:isMe?`1px solid ${col.border}`:"1px solid transparent"}}>
                    ...
                    <div style={{flex:1}}>
                      ...
                      {isMe&&<span style={{fontFamily:"Barlow,sans-serif",fontSize:9,color:col.primary,marginLeft:7,background:col.bg,border:`1px solid ${col.border}`,borderRadius:6,padding:"1px 6px"}}>YOU</span>}
                    </div>
      ...
      {feedbacks.length===0
        ? <div style={{background:"#0f0b1e",border:"1px solid #1a1a1a",borderRadius:12,padding:"36px",textAlign:"center"}}>
            ...
            <div style={{fontFamily:"Barlow,sans-serif",fontSize:11,color:"#3d2080"}}>Judges haven't submitted feedback yet.</div>
          </div>
